...
Write-Host "Start windows scheduler task \JDA\multidailycreatefloor"
 ...
 $pdflog|out-file -encoding ASCII \\USHQFS1\Storemaps$\Manual_PDF\log\PDFLogHeader.txt
        ...
        Do
        {	
       Remove-Item "\\USHQFS1\Storemaps$\Manual_PDF\log\processedPDFs.txt"	
     ...
     $inputString = Get-Content "\\USHQFS1\Storemaps$\Manual_PDF\log\processedPDFs.txt"
